...
<h3 align="center">KobeScraper</h3>
  ...
  <p align="center">
    A Computer Vision model that uses pose estimation and player tracking algorithms along with the YOLOv8 object detection model for compiling unique Kobe Bryant highlights based on a user's chosen move.
    <!-- <br />
...
- [ ] Transfer learn model on recognizing Kobe Bryant moves in hghlights through pose estimation
- [ ] Train model to recognize Kobe Bryant in highlights

See the [open issues](https://github.com/sammig6i/KobeScraper/issues) for a full list of proposed features (and known issues).
